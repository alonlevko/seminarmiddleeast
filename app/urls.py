...
urlpatterns = [
               ...
               path('users/<slug:name>', views.show_users_list, name="users_list"),
               path('users-get', views.show_users_place, name="users_get"),
               path('popular_users/<slug:name>', views.popular_users, name="popular_users"),
               ...
               path('top_words_per_date/<slug:name>', views.top_words_per_date, name='top_words_per_date'),
               path('top_words_per_date_get', views.top_words_per_date_get, name='top_words_per_date_get'),
               path('popularity_of_words/<slug:name>', views.popularity_of_words, name='popularity_of_words'),
               path('popularity_of_words_get', views.popularity_of_words_get, name='popularity_of_words_get'),
               path('most_popular_word/<slug:name>', views.most_popular_word, name='most_popular_word'),
